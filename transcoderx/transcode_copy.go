...
func Pipeline(ffmpegBin string, ph interfacex.ProgressHandle, args interfacex.IArg, cmdHandle metadatax.CmdHandle, handles ...func(process *os.Process)) (<-chan metadatax.Progress, error) {
	err := verifyBin(ffmpegBin)
	if err != nil {
		return nil, err
	}
