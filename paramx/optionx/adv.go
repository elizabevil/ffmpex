...
type ExpertInput struct {
	...
	SeekTimestamp typex.Number `json:"seek_timestamp" flag:"-reinit_filter"` //         OPT_TYPE_INT, OPT_OFFSET | OPT_INPUT | OPT_EXPERT,
	...
	Discard Discard `json:"discard" flag:"-discard"` //             OPT_TYPE_STRING, OPT_PERSTREAM | OPT_INPUT | OPT_EXPERT,
	...
	CanvasSize typex.String `json:"canvas_size" flag:"-canvas_size"` // OPT_TYPE_STRING, OPT_SUBTITLE | OPT_PERSTREAM | OPT_INPUT | OPT_EXPERT,
...
type ExpertOutput struct {
	...
	TimeBase                 typex.String  `json:"time_base" flag:"-time_base"`                                     //typex.String, OPT_EXPERT | OPT_PERSTREAM | OPT_OUTPUT,
	...
	FpsMode                  typex.String  `json:"fps_mode" flag:"-fps_mode"`                                       //typex.String, OPT_VIDEO | OPT_EXPERT | OPT_PERSTREAM | OPT_OUTPUT,
...
type Expert struct {
	...
	Copytb              typex.Number `json:"copytb" flag:"-copytb"`                               //                 OPT_TYPE_INT, OPT_EXPERT,
...
type Discard = typex.String

const (
	Discard_none Discard = "none"
	//Discard no frame.
	Discard_default Discard = "default"
	//Default, which discards no frames.
	Discard_noref Discard = "noref"
	//Discard all non-reference frames.
	Discard_bidir Discard = "bidir"
	//Discard all bidirectional frames.
	Discard_nokey Discard = "nokey"
