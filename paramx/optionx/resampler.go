...
type Resampler struct {
	...
	Isr          string `json:"isr" flag:"-isr"`
	InSampleRate string `json:"in_sample_rate" flag:"-in_sample_rate"`
	//Set the input sample rate. Default value is 0.

	Osr           string `json:"osr" flag:"-osr"`
	OutSampleRate string `json:"out_sample_rate" flag:"-out_sample_rate"`
	//Set the output sample rate. Default value is 0.

	Isf         string `json:"isf" flag:"-isf"`
	InSampleFmt string `json:"in_sample_fmt" flag:"-in_sample_fmt"`
	//Specify the input sample format. It is set by default to none.

	Osf          string `json:"osf" flag:"-osf"`
	OutSampleFmt string `json:"out_sample_fmt" flag:"-out_sample_fmt"`
	//Specify the output sample format. It is set by default to none.

	Tsf               string `json:"tsf" flag:"-tsf"`
	InternalSampleFmt string `json:"internal_sample_fmt" flag:"-internal_sample_fmt"`
	//Set the internal sample format. Default value is none. This will automatically be chosen when it is not explicitly set.

	Ichl        string `json:"ichl" flag:"-ichl"`
	InChlayout  string `json:"in_chlayout" flag:"-in_chlayout"`
	Ochl        string `json:"ochl" flag:"-ochl"`
	OutChlayout string `json:"out_chlayout" flag:"-out_chlayout"`
	...
	Flags    bool `json:"flags" flag:"-flags"`
	SwrFlags bool `json:"swr_flags" flag:"-swr_flags"`
